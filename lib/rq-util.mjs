...
// - - - - - - - - - - - - - - - - - - - -
// shorthands
const log = consoleUtil.getLogger("[request-util]:", isNode);
...
export const getUniversalLogger = (banner) => {
    return consoleUtil.getLogger(banner, isNode);
};
export function getLogger() {
    const clog = consoleUtil.getLogger('- - -> Get the character data of "CCP Zoetrope"'.magenta, isNode);
    const rlog = consoleUtil.getLogger("- - -> Run ESI request".cyan, isNode);
