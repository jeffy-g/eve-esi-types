 ...
 */
// /**
//  * An adapter that supports both the function signature version and the method map version,
//  * and always returns the form "(method, endpoint, options?) → Promise<R>".
//  */
// function unifyRequestFn<Opt extends Record<string, unknown>>(
//     fn: TESIRequestFunctionSignature2<Opt> |
//         TESIRequestFunctionMethods2<Opt>
//   ): TESIRequestFunctionSignature2<Opt> {
//     if (typeof fn === "function") {
//         // already (method, endpoint, opt?) → R
//         return fn as TESIRequestFunctionSignature2<Opt>;
//     }
//     // when map type
//     const map = fn as TESIRequestFunctionMethods2<Opt>;
//     return ((method, endpoint, options) =>
//         // @ts-expect-error
//         map[method](endpoint, options)
//     ) as TESIRequestFunctionSignature2<Opt>;
// }
/**
...
const fireWithoutAuth = (fn, method, endpoint, ...opt) => {
    ...
    return fn[method](endpoint, arg);
    /*/
    const arg: typeof opt[0] = opt.length ? opt[0] : void 0;
    if (isFn(fn)) {
        // @ts-expect- error
        // return fn(method, endpoint, /** @type {Parameters<typeof fn>[2]} * /(arg) as Parameters<typeof fn>[2]);
    }
